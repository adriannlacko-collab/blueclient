...
public class BossBarModule extends Module {
   ...
   public int drawnBars(class_310 client) {
      if (client.field_1705 == null) {
         ...
         if (held == 0) {
            ...
            int limit = client.method_22683().method_4502() / 3;
            int pitch = 10 + 9;
            int drawn = 0;
            int y = 12;
   ...
   public int[] vanillaPlace(class_310 client) {
      return this.drawnBars(client) == 0 ? null : new int[]{client.method_22683().method_4486() / 2 - 91, 3};
   }
