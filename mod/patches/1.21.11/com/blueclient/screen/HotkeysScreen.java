...
public class HotkeysScreen extends VanillaScreen {
   ...
   protected int content(int top) {
      ...
      add.method_47400(class_7919.method_47407(class_2561.method_43470("A new hotkey: pick its key, then add the chat lines or commands it sends")));
      ...
      class_4185 settings = class_4185.method_46430(
         ...
         .method_46431();
      settings.method_47400(class_7919.method_47407(class_2561.method_43470("The Hotkeys switch and the gap between chat lines")));
   ...
   private void addRow(HotkeysModule.Hotkey hotkey, int x, int y) {
      ...
      toggle.method_47400(class_7919.method_47407(hotkey.summary()));
      this.method_37063(toggle);
      class_4185 run = class_4185.method_46430(class_2561.method_43470("▶").method_27692(class_124.field_1060), button -> {
         if (module != null) {
            Screens.open(this.field_22787, null);
            module.send(this.field_22787, hotkey);
         }
      }).method_46434(x + toggleW + 2, y, SMALL_W, 20).method_46431();
      run.field_22763 = module != null && module.isEnabled() && !hotkey.lines.isEmpty() && this.field_22787 != null && this.field_22787.field_1724 != null;
      run.method_47400(class_7919.method_47407(class_2561.method_43470("Close this menu and send it now")));
