...
public final class Presets {
   ...
   static void adopt(JsonObject root) {
      ...
      JsonObject stored = profiles != null && profiles.isJsonObject() ? profiles.getAsJsonObject() : null;
      if (stored != null) {
      ...
      JsonElement named = root.get("activeProfile");
      String wanted = named != null && named.isJsonPrimitive() ? named.getAsString() : "Default";
